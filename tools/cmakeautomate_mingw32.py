...
if os.path.exists(mingw_path):
    ...
    print(f"cmake -G \"Ninja\" -DCMAKE_MAKE_PROGRAM={ninja_exe_path} -DCMAKE_PREFIX_PATH={mingw_path} -DCMAKE_C_COMPILER={c_compiler_path} -DCMAKE_CXX_COMPILER={cxx_compiler_path} ..")
    ...
    print("mingw32 folder is not found on the repo directory")
